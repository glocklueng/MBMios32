// $Id: mm_gpc.c 1491 2012-07-29 20:41:15Z tk $
/*
 * MIDIbox MM V3
...
/////////////////////////////////////////////////////////////////////////////
u8 MM_GPC_VPotValueGet(u8 vpot)
{
...
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_Received(mios32_midi_package_t package)
{
#if 0
  // TODO: GPC events
...
/////////////////////////////////////////////////////////////////////////////
// This function is called from MM_GPC_Received
// when a GPC value has been received via MIDI
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_AbsValue_Received(u8 entry, u8 value)
{
  // store value
...
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_Msg_Update(void)
{
  int i, j;
  char *gpc_msg_ptr = (char *)&gpc_msg[0x00];

  for(i=0; i<8; ++i) {
    char *gpc_label_ptr = (char *)&mm_gpc_lables[gpc_offset*5 + i];
...
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_Msg_UpdateValues(void)
{
  int i;
...
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_SendENCEvent(u8 encoder, s32 incrementer)
{
  ...
  // store new value
  MM_GPC_AbsValue_Received(entry, (u8)new_value);
...
/////////////////////////////////////////////////////////////////////////////
s32 MM_GPC_SendJogWheelEvent(s32 incrementer)
{
