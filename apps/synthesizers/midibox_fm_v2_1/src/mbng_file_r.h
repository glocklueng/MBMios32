// $Id: mbng_file_r.h 1791 2013-05-24 20:45:16Z tk $
/*
...
extern s32 MBNG_FILE_R_Parser(u32 line, char *line_buffer, u8 *if_state, u8 *nesting_level);

extern s32 MBNG_FILE_R_Read(char *filename, u8 cont_script);
