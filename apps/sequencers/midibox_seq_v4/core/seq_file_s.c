// $Id: seq_file_s.c 1493 2012-08-03 20:54:45Z tk $
/*
...
// returns < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 SEQ_FILE_S_SaveAllBanks(char *session)
{
  s32 status = SEQ_FILE_S_SongWrite(session, SEQ_SONG_NumGet(), 0);

#if DEBUG_VERBOSE_LEVEL >= 1
  DEBUG_MSG("[SEQ_FILE_S] Tried to store songs, status: %d\n", status);
#endif
