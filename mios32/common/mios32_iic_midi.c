// $Id: mios32_iic_midi.c 2133 2015-01-26 21:36:08Z tk $
...
# endif
  ...
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI0_RI_N_PORT, MIOS32_IIC_MIDI0_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI1_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI1_RI_N_PORT, MIOS32_IIC_MIDI1_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI1_RI_N_PORT, MIOS32_IIC_MIDI1_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI2_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI2_RI_N_PORT, MIOS32_IIC_MIDI2_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI2_RI_N_PORT, MIOS32_IIC_MIDI2_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI3_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI3_RI_N_PORT, MIOS32_IIC_MIDI3_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI3_RI_N_PORT, MIOS32_IIC_MIDI3_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI4_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI4_RI_N_PORT, MIOS32_IIC_MIDI4_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI4_RI_N_PORT, MIOS32_IIC_MIDI4_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI5_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI5_RI_N_PORT, MIOS32_IIC_MIDI5_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI5_RI_N_PORT, MIOS32_IIC_MIDI5_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI6_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI6_RI_N_PORT, MIOS32_IIC_MIDI6_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI6_RI_N_PORT, MIOS32_IIC_MIDI6_RI_N_PIN, 0);
#endif
#if MIOS32_IIC_MIDI7_ENABLED == 3
  MIOS32_SYS_LPC_PINSEL(MIOS32_IIC_MIDI7_RI_N_PORT, MIOS32_IIC_MIDI7_RI_N_PIN, 0);
  MIOS32_SYS_LPC_PINDIR(MIOS32_IIC_MIDI7_RI_N_PORT, MIOS32_IIC_MIDI7_RI_N_PIN, 0);
#endif
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 0: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI0_RI_N_PORT, MIOS32_IIC_MIDI0_RI_N_PIN) ? 0 : 1;
# else
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 1: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI1_RI_N_PORT, MIOS32_IIC_MIDI1_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 2: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI2_RI_N_PORT, MIOS32_IIC_MIDI2_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 3: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI3_RI_N_PORT, MIOS32_IIC_MIDI3_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 4: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI4_RI_N_PORT, MIOS32_IIC_MIDI4_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 5: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI5_RI_N_PORT, MIOS32_IIC_MIDI5_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 6: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI6_RI_N_PORT, MIOS32_IIC_MIDI6_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
...
# elif defined(MIOS32_FAMILY_LPC17xx)
    case 7: return MIOS32_SYS_LPC_PINGET(MIOS32_IIC_MIDI7_RI_N_PORT, MIOS32_IIC_MIDI7_RI_N_PIN) ? 0 : 1;
# else
# warning "unsupported MIOS32_FAMILY"
