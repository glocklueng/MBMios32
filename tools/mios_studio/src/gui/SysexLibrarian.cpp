...
// $Id: SysexLibrarian.cpp 2180 2015-06-14 19:21:59Z tk $
/*
...
void SysexLibrarianControl::setSpec(const unsigned& spec)
{
    if( spec < miosStudio->sysexPatchDb->getNumSpecs() ) {
        ...
        if( bufferName.isEmpty() )
            bufferLabel->setText(bufferName, sendNotification); // empty...
        else
            bufferLabel->setText(bufferName + String(T(":")), sendNotification); // empty...
